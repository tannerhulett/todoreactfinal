...
export default function ToDoForm(props) {
    ...
    const getCategories = () => {
        axios.get(`http://todoapi.tannerhulett.com/api/Categories`).then(response => setCategories(response.data))
    }
    ...
    const handleSubmit = (values) => {
        ...
        if (!props.todo) {
            ...
            axios.post(`http://todoapi.tannerhulett.com/api/ToDos`, newToDo).then(() => {
                props.getToDos()
            ...
            axios.put(`http://todoapi.tannerhulett.com/api/ToDos/${props.todo.toDoId}`, taskToEdit).then(() => {
                props.getToDos()
